...
class EmployeeResourceIT {
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee().profile_id(DEFAULT_PROFILE_ID).hire_date(DEFAULT_HIRE_DATE);
        return employee;
    }
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee().profile_id(UPDATED_PROFILE_ID).hire_date(UPDATED_HIRE_DATE);
        return employee;
    }
    ...
    void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getProfile_id()).isEqualTo(DEFAULT_PROFILE_ID);
        assertThat(testEmployee.getHire_date()).isEqualTo(DEFAULT_HIRE_DATE);
    }
    ...
    @Test
    @Transactional
    void checkHire_dateIsRequired() throws Exception {
        int databaseSizeBeforeTest = employeeRepository.findAll().size();
        // set the field null
        employee.setHire_date(null);
    ...
    void putNewEmployee() throws Exception {
        ...
        updatedEmployee.profile_id(UPDATED_PROFILE_ID).hire_date(UPDATED_HIRE_DATE);
        ...
        Employee testEmployee = employeeList.get(employeeList.size() - 1);
        assertThat(testEmployee.getProfile_id()).isEqualTo(UPDATED_PROFILE_ID);
        assertThat(testEmployee.getHire_date()).isEqualTo(UPDATED_HIRE_DATE);
    }
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.hire_date(UPDATED_HIRE_DATE);
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.profile_id(UPDATED_PROFILE_ID).hire_date(UPDATED_HIRE_DATE);
